...
![User Setting Filters](user-settings-detailed-04.png)
...
![Drive Mapping](user-settings-detailed-05.png)
...
![Warning Message](user-settings-detailed-06.png)
...
![Environment Variables](user-settings-detailed-07.png)
...
![File Type Association](user-settings-detailed-11.png)
...
![Select content store](user-settings-detailed-12.png)
...
![Enter Package Name](user-settings-detailed-13.png)
...
![File Type Associations](user-settings-detailed-16.png)

When you have added your FTA details, click the **Save Package** button in the toolbar.

![Save Package](user-settings-detailed-17.png)
...
![Select Code Sign Certificate](user-settings-detailed-18.png)
...
![Publish or Close](user-settings-detailed-19.png)
...
![Copy Files and Folders](user-settings-detailed-20.png)

When **Delete** is selected, only a single field is shown to enter the path or file to delete.

![Delete Files and Folders](user-settings-detailed-21.png)
...
![Printer Mapping](user-settings-detailed-24.png)
...
![Native Shortcuts](user-settings-detailed-26.png)
...
![Select content store for MSIX Shortcuts](user-settings-detailed-27.png)
...
![Create MSIX Shortcut](user-settings-detailed-28.png)
...
![Save package](user-settings-detailed-30.png)

All MSIX packages must be signed. Select the code signing certificate to use. If you only have one, it will already be selected. When finished, click **Continue**.

![Select Code Sign Certificate](user-settings-detailed-31.png)
...
![Close or Publish Shortcut](user-settings-detailed-32.png)
...
![Add User or Group](user-settings-detailed-33.png)

Select one or more items and drag them to the group you want to assign them to.

![Drag objects to group assignment](user-settings-detailed-34.png)

Confirm the changes by clicking **Yes**, or click **No** to cancel.

![Confirm changes](user-settings-detailed-35.png)

All your assignments are visible in the **User Group Assignments** pane.

![User Group Assignments](user-settings-detailed-36.png)
...
![Create Folders](user-settings-detailed-37.png)

Enter a name for the folder and click **OK**.

![Enter Folder Name](user-settings-detailed-38.png)

The selected items are moved to the newly created folder.

![Move Item](user-settings-detailed-39.png)
