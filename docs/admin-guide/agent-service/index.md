...
![Refresh cycle blue circle](agent-service-02.jpg)
...
![Refresh cycle in Central View](agent-service-05.png)

![Refresh cycle machine group](agent-service-06.png)
