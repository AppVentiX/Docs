...
![Create storage account](images/azure-file-share/azure-file-share-01.png)

Give the storage account a name and select your region:

![Storage account name and region](images/azure-file-share/azure-file-share-02.png)
...
![File shares menu](images/azure-file-share/azure-file-share-03.png)

Select **New File Share**:

![New file share](images/azure-file-share/azure-file-share-04.png)
...
![File share tier selection](images/azure-file-share/azure-file-share-05.png)
...
![Create config and content folders](images/azure-file-share/azure-file-share-06.png)

### Step 4: Get the Access Key

Go to the storage account main menu and click on **Access Keys**:

![Access keys menu](images/azure-file-share/azure-file-share-07.png)
...
![Central View share configuration](images/azure-file-share/azure-file-share-08.png)
...
![Configuration example](images/azure-file-share/azure-file-share-09.png)
...
![Content folder in machine group](images/azure-file-share/azure-file-share-10.png)
...
![Join share to Active Directory](images/azure-file-share/azure-file-share-11.png)
...
![Service account permissions](images/azure-file-share/azure-file-share-13.png)

Then enter this account in the Central View settings window:

![Service account in Central View settings](images/azure-file-share/azure-file-share-14.png)
