...
![Enable App Control from the App Control pane](images/app-control/app-control-01.png)
...
![Enable App Control in Machine Group settings](images/app-control/app-control-02.png)
...
![App Control history and event collection settings](images/app-control/app-control-03.png)
...
![Switch between Learning Mode and Enforced Mode](images/app-control/app-control-04.png)
...
![Refresh Workspace in the Start Menu](images/app-control/app-control-05.png)

A popup shows the sync progress. Click **Show progress** for more detail.

![Refresh Workspace progress](images/app-control/app-control-06.png)
...
![App Control Log](images/app-control/app-control-07.png)
...
![User Mode and Kernel Mode options](images/app-control/app-control-08.png)
...
![Create a policy manually](images/app-control/app-control-09.png)
...
![Create the Publisher rule](images/app-control/app-control-11.png)

A name is generated based on the rule you created. You can change it if needed.

![Save the Publisher rule](images/app-control/app-control-12.png)
...
![Create a Publisher policy from an event](images/app-control/app-control-13.png)
...
![Configure the Publisher rule](images/app-control/app-control-14.png)

A default name is generated based on the rule type and publisher name. Change it if needed, then click **Save Policy**.

![Save the Publisher policy](images/app-control/app-control-15.png)
...
![Create a policy from an unsigned event](images/app-control/app-control-16.png)

On the next page, verify that everything is correct and click **Create Rule**.

![Create the File Path rule](images/app-control/app-control-17.png)
...
![Name the combined File Path policy](images/app-control/app-control-18.png)

To add rules to an existing policy, select the items you want to add and click **Add Rule(s) to Existing Policy**.

![Add rules to an existing policy](images/app-control/app-control-19.png)

Select the policy you want to add the rules to and click **OK** to continue.

![Select the existing policy](images/app-control/app-control-20.png)

Verify the rule to add and click **Create Rule**.

![Verify the rule to add](images/app-control/app-control-21.png)

When you are finished adding rules, click **Save Policy**.

![Save the policy](images/app-control/app-control-22.png)
...
![Assign and activate policies](images/app-control/app-control-23.gif)
...
![Enable Enforced Mode](images/app-control/app-control-24.gif)
...
![Notepad++ allowed and 7-Zip blocked](images/app-control/app-control-25.png)
