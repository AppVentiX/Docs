...
![Admin consent checkbox](images/entra-id/entra-id-02.png)
...
![Add platform - mobile and desktop](images/entra-id/entra-id-03.png)
...
![Redirect URI configuration](images/entra-id/entra-id-04.png)
...
![API permissions configuration](images/entra-id/entra-id-05.png)
...
![Advanced Azure AD settings](images/entra-id/entra-id-08.png)
