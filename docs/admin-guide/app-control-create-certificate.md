...
![Click Configure Certificate for Policy Signing](images/app-control-create-certificate/app-control-create-certificate-01.png)
...
![Two options available](images/app-control-create-certificate/app-control-create-certificate-02.png)
...
![Fill the fields and click Generate and save certificate](images/app-control-create-certificate/app-control-create-certificate-03.png)

Click **Yes** to continue or **No** to cancel.

![Click Yes to continue](images/app-control-create-certificate/app-control-create-certificate-04.png)

Click **Close**.

![Click Close](images/app-control-create-certificate/app-control-create-certificate-05.png)

## Create Azure Code Signing certificate

Click **Configure Azure Code Signing**.

![Click Configure Azure Code Signing](images/app-control-create-certificate/app-control-create-certificate-06.png)
...
![Automatic or Manual](images/app-control-create-certificate/app-control-create-certificate-07.png)
...
![Select Automatic and click Next](images/app-control-create-certificate/app-control-create-certificate-08.png)

Make sure that all required modules and software are installed before continuing.

![Required modules and software overview](images/app-control-create-certificate/app-control-create-certificate-09.png)
...
![Click Next](images/app-control-create-certificate/app-control-create-certificate-10.png)

Click **Sign in to Azure**.

![Click Sign in to Azure](images/app-control-create-certificate/app-control-create-certificate-11.png)

Close the browser when authentication is successful.

![Close the browser](images/app-control-create-certificate/app-control-create-certificate-12.png)

When signed in, click **Next**.

![Click Next](images/app-control-create-certificate/app-control-create-certificate-13.png)
...
![Enter the details and click Next](images/app-control-create-certificate/app-control-create-certificate-14.png)

Click the **Open identity validations in portal** button.

![Click Open identity validations in portal](images/app-control-create-certificate/app-control-create-certificate-15.png)
...
![Create a Private identity](images/app-control-create-certificate/app-control-create-certificate-16.png)

Make sure all required fields are filled and click **Create** when finished.

![Fill the required fields and click Create](images/app-control-create-certificate/app-control-create-certificate-17.png)
...
![Copy the Identity validation id](images/app-control-create-certificate/app-control-create-certificate-18.png)

Paste the copied Identity validation ID in the field of the same name and click **Finish** to close the wizard.

![Paste the ID and click Finish](images/app-control-create-certificate/app-control-create-certificate-19.png)
...
![Click OK](images/app-control-create-certificate/app-control-create-certificate-20.png)

### Manual

Select the **Manual** option and click **Next**.

![Select Manual and click Next](images/app-control-create-certificate/app-control-create-certificate-21.png)

Before continuing, make sure the required modules [are installed](#installation-of-required-modules).
Click **Next** to continue.

![Click Next](images/app-control-create-certificate/app-control-create-certificate-22.png)
...
![Make a note of the account name and URI](images/app-control-create-certificate/app-control-create-certificate-23.png)

Under **Certificate profiles**, make a note of the profile name.

![Make a note of the profile name](images/app-control-create-certificate/app-control-create-certificate-24.png)

Fill the fields with the gathered values and click **Finish**.

![Fill the fields and click Finish](images/app-control-create-certificate/app-control-create-certificate-25.png)

Click **OK**.

![Click OK](images/app-control-create-certificate/app-control-create-certificate-26.png)
