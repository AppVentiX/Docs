...
![Create Storage Account](images/azure-manual-sa-creation/azure-manual-sa-creation-01.png)

On the **Networking** tab enable Public network access so your machines can connect to the storage account from the internet.

![Enable REST API](images/azure-manual-sa-creation/azure-manual-sa-creation-02.png)

On the **Security** tab, make sure **Require secure transfer for REST API operations** is enabled.

![Enable REST API](images/azure-manual-sa-creation/azure-manual-sa-creation-03.png)

On the **Data protection** tab you can configure the recovery options accordingly.

![Configure Data protection options](images/azure-manual-sa-creation/azure-manual-sa-creation-04.png)

On the **Encryption** tab, you can leave the settings on the default values.

![Leave Encryption settings default](images/azure-manual-sa-creation/azure-manual-sa-creation-05.png)
