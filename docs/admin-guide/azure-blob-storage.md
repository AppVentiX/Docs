...
![Select Automatic](images/azure-blob-storage/azure-blob-storage-automatic-01.png)

Click **Sign in to Azure...**

![Sign in to Azure...](images/azure-blob-storage/azure-blob-storage-automatic-02.png)

A browser popup will appear for you to sign in with your company credentials, log in.

![sign in with your company credentials](images/azure-blob-storage/azure-blob-storage-automatic-03.png)
...
![Start automatic configuration](images/azure-blob-storage/azure-blob-storage-automatic-06.png)
...
![Select subscription](images/azure-blob-storage/azure-blob-storage-automatic-07.png)

Enter a Resource Group Name and select a Region.
Click **Create** when you are ready.

![Click Create](images/azure-blob-storage/azure-blob-storage-automatic-08.png)

Click **New** to create a new Storage Account.

![Click New](images/azure-blob-storage/azure-blob-storage-automatic-09.png)
...
![Enter SA Name](images/azure-blob-storage/azure-blob-storage-automatic-10.png)
...
![Click Create](images/azure-blob-storage/azure-blob-storage-automatic-11.png)

Click **Next**

![Click Next](images/azure-blob-storage/azure-blob-storage-automatic-12.png)
...
You can follow [this](custom-app-registration.md) guide  to configure your own App Registration.
...
![App Registration](images/azure-blob-storage/azure-blob-storage-automatic-13.png)
...
You can however [select your own pxf certificate](client-certificate.md)
...
![Create or select client certificate](images/azure-blob-storage/azure-blob-storage-automatic-14.png)

Click **Finish** to finalize the wizard.
Some last configuration settings will be set and containers will be created.

![Finish](images/azure-blob-storage/azure-blob-storage-automatic-15.png)

Click **Close**.

![Click Close](images/azure-blob-storage/azure-blob-storage-automatic-16.png)

Click **Save** to start using this new configuration settings.

![Click Save](images/azure-blob-storage/azure-blob-storage-automatic-17.png)

A popup may appear for you to login again.
Enter your password and approve MFA if required.

![alt text](images/azure-blob-storage/azure-blob-storage-automatic-18.png)

When the login is successful, a popup may appear, click **Close**

![alt text](images/azure-blob-storage/azure-blob-storage-automatic-19.png)
