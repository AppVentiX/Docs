...
![Firewall rule verification](quic-share-01.jpg)

![Firewall rule output](quic-share-02.png)
...
![Block port 445 rule](quic-share-03.png)

![Block port 445 verification](quic-share-04.jpg)
...
![Local user creation](quic-share-05.jpg)

![User account result](quic-share-06.jpg)
...
![File structure creation](quic-share-07.jpg)
...
![NTFS permissions output](quic-share-08.jpg)
...
![SSL cert mapping output](quic-share-09.png)

![Cert mapping verification](quic-share-10.png)
...
![SmbClientAccessToServer check](quic-share-11.jpg)

![UDP port listener check](quic-share-12.png)

---

## Configure in Central View

![QUIC share type in Central View](quic-share-13.jpg)

Configure the QUIC share in the Central View console:

![QUIC share configuration](quic-share-14.png)
