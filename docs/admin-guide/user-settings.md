...
![Enable user settings in agent settings](images/user-settings/user-settings-01.png)

User Settings can be created and assigned to user groups:

![User settings assignment view](images/user-settings/user-settings-02.png)
...
![Tracked settings indicator](images/user-settings/user-settings-03.png)
...
![RunOnce option](images/user-settings/user-settings-04.png)
...
![RunOnce registry key](images/user-settings/user-settings-05.png)

All user setting activities are also logged in the AppVentiX agent event log:

![User settings event log entries](images/user-settings/user-settings-06.png)
...
![Shortcut package creation](images/user-settings/user-settings-07.png)

Example of a package containing shortcuts:

![Package with shortcuts](images/user-settings/user-settings-08.png)
...
![Workspace Refresh shortcut](images/user-settings/user-settings-09.png)

![Refresh shortcut icon](images/user-settings/user-settings-10.png)

A progress will be displayed during refresh:

![Refresh progress display](images/user-settings/user-settings-11.jpg)
...
![Enable refresh for user settings](images/user-settings/user-settings-12.png)
...
![Execution order setting](images/user-settings/user-settings-13.png)

![User settings overview with order](images/user-settings/user-settings-14.png)
