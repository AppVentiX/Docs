...
![alt text](images/agent-refresh-shortcut/agent-refresh-shortcut-01.png)

A popup screen will show the progress.
A refresh progress notification will be displayed:

![Refresh Workspace shortcut](images/agent-refresh-shortcut/agent-refresh-shortcut-02.jpg)

Click the **Show progress** button to see more refresh details. You can close the window when finished.

![alt text](images/agent-refresh-shortcut/agent-refresh-shortcut-03.png)
