...
![alt text](images/user-settings-filters/user-settings-filters-01.png)

Click **Add Filter**.

![alt text](images/user-settings-filters/user-settings-filters-02.png)
...
![Add machine filter](images/user-settings-filters/user-settings-filters-03.png)
...
![Add Subnet filter](images/user-settings-filters/user-settings-filters-04.png)
...
![Add Endpoint filter](images/user-settings-filters/user-settings-filters-05.png)
...
![Enter registry data](images/user-settings-filters/user-settings-filters-06.png)