...
> **Note:** Central View needs also Write permissions if you want to convert MSIX packages to App Attach or App-V packages to MSIX, or if you want to delete content from the content store directly from the console. For other management activities, only Read permissions are needed. This means you can provide the console to helpdesk/admins to operate the deployment but not change any configurations.
...
![Share permissions in Central View](images/share-permissions/share-permissions-01.png)
...
![NTFS permissions configuration](images/share-permissions/share-permissions-02.png)
...
![Agent service account configuration](images/share-permissions/share-permissions-03.png)
...
![Silent install with account](images/share-permissions/share-permissions-04.png)

This makes it easy to deploy the solution with minimal effort and get up and running quickly.

![Share permissions overview](images/share-permissions/share-permissions-05.png)
