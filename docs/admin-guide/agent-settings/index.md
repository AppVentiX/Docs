...
![General MSIX Settings](agent-settings-01.png)

**General Settings - APP-V**

![General APP-V Settings](agent-settings-02.png)

**General Settings - App Control**

![General App Control Settings](agent-settings-03.png)

**General Settings - User Settings**

![General User Settings Settings](agent-settings-04.png)
---
...
![Machine Start Actions - MSIX](agent-settings-05.png)

**Machine Start Actions - App-V**

![Machine Start Actions - App-V](agent-settings-06.png)
...
![Refresh settings - MSIX](agent-settings-07.png)

**Refresh settings - App-V**

![Refresh settings - App-V](agent-settings-08.png)

**Refresh settings - User Settings**

![Refresh settings - User Settings](agent-settings-09.png)
...
![Client Settings - MSIX](agent-settings-10.png)

**Client Settings - App-V**

![Client Settings - App-V](agent-settings-11.png)
...
![Advanced Settings - MSIX](agent-settings-13.png)

**Advanced Settings - App-V**

![Advanced Settings - App-V](agent-settings-14.png)