...
![Content inventory overview](images/manage-content/manage-content-01.png)
...
![Package options window](images/manage-content/manage-content-02.png)

---

## Creating a Publishing Task

![Publishing task creation - MSIX and App-V](images/manage-content/manage-content-03.png)

![Publishing task options](images/manage-content/manage-content-04.png)
...
![Publish as RemoteApp configuration](images/manage-content/manage-content-05.png)
...
![Publish as RemoteApp - extended view](images/manage-content/manage-content-06.png)

There is also a direct integration with [Azure Virtual Desktop (AVD)](azure-virtual-desktop.md), which will publish the application directly in AVD and also remove the application when the publishing task is removed.
...
![Auto start applications](images/manage-content/manage-content-07.png)
...
![Package options window](images/manage-content/manage-content-08.png)
...
![After stage actions](images/manage-content/manage-content-09.png)
...
![After stage actions example](images/manage-content/manage-content-10.png)
...
![Show publishing tasks and package options buttons](images/manage-content/manage-content-11.jpg)
...
![Content page actions ribbon](images/manage-content/manage-content-12.png)
