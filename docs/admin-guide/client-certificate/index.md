...
![Client Expiring](client-certificate-01.png)
...
![Generate a new Certificate](client-certificate-03.png)

Review your new settings, click **Finish** to apply the new settings.

![Click Finish](client-certificate-04.png)

When the popup shows, you can click **Close**

![Click Close](client-certificate-05.png)

Click **Save**.

![Click Save](client-certificate-06.png)
...
![Select Machines](client-certificate-07.png)

Click **OK** to start the certificate rotation.

![Click OK](client-certificate-08.png)

Click **OK** to close

![Click OK](client-certificate-09.png)

To view the status, click **Show rotation status** on the **Machines & Inventory** tab.

![alt text](client-certificate-10.png)
