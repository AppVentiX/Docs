...
[![AppVentiX Technical Architecture - SMB file share deployment](images/architecture/technical-architecture.png)](images/architecture/technical-architecture.png){target="_blank"}

Azure Blob storage deployment:

[![AppVentiX Technical Architecture - Azure Blob storage deployment](images/architecture/technical-architecture-blob.png)](images/architecture/technical-architecture-blob.png){target="_blank"}
