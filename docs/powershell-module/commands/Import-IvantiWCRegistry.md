...
```
Import-IvantiWCRegistry [-XmlFilePath] <string> [[-MachineGroupFriendlyName] <string>]
...
Extracts registry setting definitions from an Ivanti WC XML file and creates corresponding
...
Function  : Import-IvantiWCRegistry
