...
title: Import-IvantiWCPrinterMapping
---
...
Extracts printer mapping definitions from an Ivanti WC XML file and creates corresponding
...
Function  : Import-IvantiWCPrinterMapping
