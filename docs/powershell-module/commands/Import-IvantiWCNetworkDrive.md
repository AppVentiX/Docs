...
title: Import-IvantiWCNetworkDrive
---
...
```
Import-IvantiWCNetworkDrive [-XmlFilePath] <string> [[-DomainFqdn] <string>]
...
Extracts network drive mapping definitions from an Ivanti WC XML file and creates corresponding
